...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video("**Your Request to join {} was Approved.**".format(m.chat.title))
        add_user(kk.id)
