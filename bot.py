...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_message(kk.id,"**Congratulations, Your Request to join <b>{}</b> was Approved.**".format(m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            await m.reply_text("**Iam an Auto Join Request Approve Bot. Just Add me and Make Admin**", reply_markup=keyboard)
